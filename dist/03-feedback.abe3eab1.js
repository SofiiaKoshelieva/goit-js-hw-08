...
var formEl = document.querySelector('.feedback-form');
initForm();
...
function onFormSubmit(evt) {
  evt.preventDefault();
  var formElements = evt.target.elements;
...
function onFormInput(evt) {
  var userData = localStorage.getItem(STORAGE_KEY);
...
function initForm() {
  var savedUserData = localStorage.getItem(STORAGE_KEY);

  if (savedUserData) {
    savedUserData = JSON.parse(savedUserData);
    Object.entries(savedUserData).forEach(function (_ref) {
